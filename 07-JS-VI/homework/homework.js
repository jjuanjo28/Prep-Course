...
function mayuscula(nombre) {
  ...
  //Tu código:
var primeraMayscula = nombre;
return (primeraMayscula[0].toUpperCase() + primeraMayscula.substring(1));
}
...
function sumarArray(numeros, cb) {
  ...
  //Tu código:
var sumaReduce = numeros.reduce(function(cb,numeros){
  return numeros + cb;
 },0);
 cb(sumaReduce);
...
function forEach(array, cb) {
  ...
  // Pista: Estarás invocando a `cb` varias veces (una por cada valor en la 
  // matriz)
  // Tu código:
